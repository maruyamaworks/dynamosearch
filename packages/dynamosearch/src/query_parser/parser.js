...
function peg$parse(input, options) {
  ...
  function peg$f0(head, tail) {    return createBooleanQuery(head, tail);  }
  function peg$f1(text, slop) {    return createMatchPhraseQuery(text, slop);  }
  function peg$f2(text) {    return createMatchQuery(text);  }
  function peg$f3(n) {    return parseInt(n, 10);  }
